...
@section('content')
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <form method="POST" action="{{ route('out.update', [$outs->id]) }}" enctype="multipart/form-data">
                        ...
                        <!-- Form Create Product(s) -->
                            ...
                            <div class="align-items-center">
                                <div class="form-group row">
                                    <label for="out" class="form-label font-weight-bold col-sm-2">
                                        Product Out</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="out" class="form-control bg-light border-0 small" value="{{ $outs->out }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="price" class="form-label font-weight-bold col-sm-2">
                                        Customer</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="customer" class="form-control bg-light border-0 small" value="{{ $outs->customer }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="date" class="form-label font-weight-bold col-sm-2">
                                        Price</label>
                                    <div class="col-sm-10">
                                        <input type="number" name="price" class="form-control bg-light border-0 small" value="{{ $outs->price }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="date" class="form-label font-weight-bold col-sm-2">
                                ...
                                <div class="form-group row">
                                    <label for="desc" class="form-label font-weight-bold col-sm-2">
                                        Description</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="desc" class="form-control bg-light border-0 small" value="{{ $outs->desc }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="date" class="form-label font-weight-bold col-sm-2">
                                        Send Date</label>
                                    <div class="col-sm-10">
                                        <input type="date" name="date" class="form-control bg-light border-0 small" value="{{ $outs->date }}">
                                    </div>
                                </div>
                            </div>
                            <hr>
