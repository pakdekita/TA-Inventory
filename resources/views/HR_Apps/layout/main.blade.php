        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ url('/cobaDivisi') }}">Semua Divisi</a>
                        <a class="collapse-item" href="{{ url('/cobaTambahDivisi') }}">Tambah Divisi</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('employee.index') }}">Data Pegawai</a>
                        <a class="collapse-item" href="{{ url('/cobaHistoryPegawai') }}">History Pegawai</a>
                        <a class="collapse-item" href="#">Pelatihan</a>
                    </div>
                </div>
            </li>

            <!-- Nav Item - Surat HR Menu -->
            <li class="nav-item">
                <a class="nav-link" href="#">
                    <i class="fas fa-fw fa-envelope"></i>
                    <span>Surat HR</span></a>
            </li>
